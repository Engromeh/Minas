        ...
        {[...Array(3)].map((_, index) => (
          <React.Fragment key={index}>
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center p-4">
              <div className="md:col-span-8 p-4 rounded-lg">
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                  <div className="flex flex-col bg-[#6BDBFF2B] sm:col-span-3 p-4 sm:p-6 rounded-[20px]">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className={`flex justify-between ${i > 0 ? "pt-6 sm:pt-12" : ""}`}>
                        <p className="text-[#798494] text-sm sm:text-[15px]">Client</p>
                        <p className="text-[#798494] text-sm sm:text-[15px] font-semibold">Company Currency</p>
                      </div>
                    ))}
                  </div>
              ...
              <div className="md:col-span-4 bg-white p-4 rounded-lg">
                <div className="p-2 bg-[#6BDBFF2B] rounded-[20px] flex flex-wrap sm:flex-nowrap justify-between items-center">
                  <div className="flex flex-col items-start">
                    <p className="text-black text-xs sm:text-sm">Wed 13 Dec, 2023</p>
                ...
                <div className="mt-2 flex justify-between">
                  ...
                  <p className="text-base sm:text-[20px] font-bold text-[#F3B858]">$500</p>
                </div>
                <div className="mt-2 flex justify-between">
                  <p className="text-xs sm:text-[15px] text-[#798494]">Branch</p>
                  <p className="text-xs sm:text-[15px] text-[#798494]">Date Ticket</p>
                </div>
              </div>
            </div>
