...
const Bookflight = () => {
  ...
  return (
    <div className="relative bg-white rounded-xl shadow-lg p-6 flex flex-col md:flex-row items-center gap-4 md:gap-6 max-w-4xl mx-auto mt-3">
      ...
      <div className="w-full md:w-1/2 space-y-4">
        ...
        <button className="w-full md:w-auto bg-blue-900 text-white py-2 px-6 rounded-lg font-bold hover:bg-blue-800 transition">
          البحث عن رحلة
        </button>
      </div>
    </div>
