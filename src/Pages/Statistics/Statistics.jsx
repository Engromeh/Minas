...
const Statistics = () => {
  return (
    <div className="box-show grid grid-cols-2 xs:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
        <div className="flex flex-col text-left">
          <h3 className="text-2xl font-bold text-[#09121E]">33</h3>
          <p className="text-sm text-gray-500">حجوزات متممة</p>
        </div>
      ...
      <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
        <div className="flex flex-col text-left">
          <h3 className="text-2xl font-bold text-[#09121E]">12</h3>
          <p className="text-sm text-gray-500">الحجوزات الملغية</p>
        </div>
      ...
      <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
        <div className="flex flex-col text-left">
          <h3 className="text-2xl font-bold text-[#09121E]">12</h3>
          <p className="text-sm text-gray-500">إجمالي المال</p>
        </div>
